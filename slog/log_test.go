...
// TestLoggerInterface tests the SLogger interface.
...
func TestErrorFallback(t *testing.T) {
	...
	if err == nil {
		...
		//var e *MarshalError
		//errors.As(err, &e)
		if err.Error() != "log: marshal field Field of type slog.TestStruct: log: marshal field Field of type string: serializer error" {
